...
#
# Compare_area is a function shipped with rotating_calipers module
# it simply calculates rectangle area based on two rectangle edges
#
# Output of a function is a tuple (a, b) where:
#  - a is a minimal value returned by the compare function (here compare_area)
#  - b is a list of desired rectangle vertices in form of (x, y)
result, vertices = rc.smallest_rectangle(Points, rc.compare_area)

print("Minimal rectangle area: ",result)
